...
class Triangle extends Shape {
  ...
  renderShape(shape) {
    shape = `<polygon fill='${this.shapeColor}' points="150, 18 244, 155 56, 155" />`;
    super.renderShape(shape);
    return shape;
  }
...
// const sampleCircle = new Circle(300, 200, "XYZ", "white", "red", "black");
// console.log(sampleCircle.renderLogo());
